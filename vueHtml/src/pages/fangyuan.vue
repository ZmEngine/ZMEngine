  ...
  <div style="height:100%;">
    ...
    <template>
      <el-table :data="tableData3" height="700" border style="width: 100%">
        ...
        <el-table-column prop="xqmc" label="小区名称" width="180">
        </el-table-column>
        <el-table-column prop="lxr" label="联系人" width="180">
        </el-table-column>
        <el-table-column prop="dianhua" label="联系电话" width="180">
        </el-table-column>
        <el-table-column prop="meno" label="房源详情" width="280">
          <template slot-scope="scope">
            <a :href="'./#/fangyuanxiangqing/'+scope.row.pid" target="_blank" style='color:blue;'>查看详情</a>            
          </template>
        </el-table-column>        
    ...
    <el-dialog title="商家信息" :visible.sync="dialogFormVisible" width="800px" center>
        ...
        <el-form-item label="小区名称">
          <el-input v-model="form.xqmc"></el-input>
        </el-form-item>
         <el-form-item label="门牌号">
          <el-input v-model="form.mph"></el-input>
        </el-form-item>
         <el-form-item label="面积">
          <el-input v-model="form.mianji"></el-input>
        </el-form-item>
         ...
         <el-form-item label="所属区域">
           <el-select v-model="form.fyqy" filterable placeholder="所属分类" size='small'>
        <el-option v-for="item in allops" :key="item.code" :label="item.name" :value="item.code">
        </el-option>
        </el-select>
        </el-form-item>
         <el-form-item label="详细地址">
          <el-input v-model="form.fydz"></el-input>
        </el-form-item>
         <el-form-item label="楼层">
          <el-col :span="8">
              <el-input v-model="form.fylc"></el-input>
            </el-col>
            <el-col class="line" :span="4">层/共</el-col>
            <el-col :span="8">
              <el-input v-model="form.fylczs"></el-input>
            </el-col>
            <el-col class="line" :span="4">层</el-col>
        </el-form-item>
         <el-form-item label="房源结构">
           <el-col :span="6">
              <el-input v-model="form.fyts_s"></el-input>
            </el-col>
            <el-col class="line" :span="2">室</el-col>
            <el-col :span="6">
              <el-input v-model="form.fyts_t"></el-input>
            </el-col>
            <el-col class="line" :span="2">厅</el-col>
            <el-col :span="6">
              <el-input v-model="form.fyts_w"></el-input>
            </el-col>
            <el-col class="line" :span="2">卫</el-col>
        </el-form-item>
         <el-form-item label="房源亮点">
          <el-input v-model="form.fyld" type="textarea" rows='5' ></el-input>
        </el-form-item>        
...
shjg:'未审核'
      ...
      btnok() {
        ...
        this.dialogFormVisible = false;
             if(this.$refs.zm_uploadsjtp.uploadFiles.length<1){
          this.$message({
            type: 'error',
            message: '房源图片至少上传一张'
          });
...
sjtp.push(this.$refs.zm_uploadsjtp.uploadFiles[tp].imgurl)
        ...
        this.form.fytp=JSON.stringify(sjtp)
