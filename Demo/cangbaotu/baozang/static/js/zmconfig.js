...
//设定上传地址
function setUpload(upurl) {
  uploadfilesrc = upurl
}

//微信分享用
var iswxready = false //标识微信api是否准备好
var fenxiangbiaoti = '' //分享标题
var fenxianglink = '' //分享的链接
var fenxiangmiaoshu = '' //分享的描述
var fenxiangimg = '' //分享的图标
var fenxianghuidiao = function (r) {
  console.log("fenxianghuidiao", r)
}
...
function wxfenxiang(obj) {
  if (obj) {
    fenxiangbiaoti = obj.biaoti
    fenxianglink = obj.link
    fenxiangimg = obj.img
    fenxiangmiaoshu = obj.miaoshu
    if (obj.huidiao) {
      fenxianghuidiao = obj.huidiao
    } else {
      fenxianghuidiao = function (r) {
        console.log("fenxianghuidiao", r)
      }
    }
  }
  if (iswxready) {
    ...
    wx.onMenuShareTimeline({
      ...
      link: fenxianglink, // 分享链接，该链接域名或路径必须与当前页面对应的公众号JS安全域名一致
      desc: fenxiangmiaoshu,
      imgUrl: fenxiangimg, // 分享图标
      success: function (r) {
        // 用户点击了分享后执行的回调函数
        fenxianghuidiao(r)
      },
      fail: function (r) {
        console.log("onMenuShareTimeline_shibai", r)
      },
      complete: function (r) {
        console.log("onMenuShareTimeline_complete", r)
      }
    })
    wx.onMenuShareAppMessage({
      ...
      success: function (rx) {
        // 用户点击了分享后执行的回调函数
         fenxianghuidiao(r)
        //console.log("onMenuShareAppMessage完成", rx)
      },
      fail: function (r) {
        console.log("onMenuShareAppMessage_shibai", r)
      },
      complete: function (r) {
        console.log("onMenuShareAppMessage_complete", r)
      }
    })
    ...
    //     // 用户点击了分享后执行的回调函数
    //     // fenxianghuidiao(r)
    //     console.log("updateTimelineShareData完成", rx)
    //   },
    //   fail: function (r) {
    //     console.log("updateTimelineShareData_shibai", r)
    //   },
    //   complete: function (r) {
    //     console.log("updateTimelineShareData_complete", r)
    //   }
    // })
    // wx.updateAppMessageShareData({
    //   title: fenxiangbiaoti, // 分享标题
    //   desc: fenxiangmiaoshu,//分享描述
    //   link: fenxianglink, // 分享链接，该链接域名或路径必须与当前页面对应的公众号JS安全域名一致
    //   imgUrl: fenxiangimg, // 分享图标
    //   success: function (rx) {
    //     // 用户点击了分享后执行的回调函数
    //     // fenxianghuidiao(r)
    //     console.log("updateAppMessageShareData完成", rx)
    //   },
    //   fail: function (r) {
    //     console.log("updateAppMessageShareData_shibai", r)
    //   },
    //   complete: function (r) {
    //     console.log("updateAppMessageShareData_complete", r)
    //   }
    // })
  }
}
