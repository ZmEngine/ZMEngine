...
(function () {
    $.fn.wdatePicker = function (options) {
        $(this).unbind("click.wdatePicker").bind("click.wdatePicker", function () {
            if (!options) options = { dateFmt: 'yyyy-MM-dd', minDate: '2010-1-1', maxDate: '2099-12-31' };
            WdatePicker(options);
        });
    }
})($);
